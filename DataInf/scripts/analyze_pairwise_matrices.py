...
def load_matrix_from_dir(results_dir: str, model: str, epoch: str, method: str) -> Optional[np.ndarray]:
    ...
    if os.path.isfile(fname_csv):
        try:
            ...
            pass
    # fallback: reconstruct from pairwise_results/*.json
...
def analyze_one_model_epoch(results_root: str, model: str, epoch: str):
    ...
    outdir = os.path.join(results_root, model, epoch, "analysis")
...
def main():
    ...
    top_summary = os.path.join(results_root, "analysis_summary.txt")
