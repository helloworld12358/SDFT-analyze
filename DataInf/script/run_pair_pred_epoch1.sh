...
"$PYTHON_BIN" "$SCRIPT_DIR/pair_pred_00_inventory_and_loader.py" --datainf_root "$DATAINF_ROOT" --all_train_datasets --all_epochs
"$PYTHON_BIN" "$SCRIPT_DIR/pair_pred_01_extract_pair_features.py" --datainf_root "$DATAINF_ROOT" --all_train_datasets --epoch epoch_1
...
"$PYTHON_BIN" "$SCRIPT_DIR/pair_pred_03_final_summary.py" --datainf_root "$DATAINF_ROOT" --epoch epoch_1
