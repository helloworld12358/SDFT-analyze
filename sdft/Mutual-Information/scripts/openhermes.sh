...
#
# Performs inference on the openhermes_train dataset using:
...
DATASET="openhermes_train"
TEMPLATE="alpaca"

# Adapter paths
ADAPTER_SDFT="checkpoints/openhermes/sdft"
ADAPTER_SFT="checkpoints/openhermes/sft"
...
# Output directories
OUT_SDFT="predictions/openhermes/sdft/inference_sdft"
OUT_SFT="predictions/openhermes/sft/inference_sft"
...
python Mutual-Information/revalue.py openhermes
echo ">>> HSIC computation completed. See results/openhermes_hsic.log"