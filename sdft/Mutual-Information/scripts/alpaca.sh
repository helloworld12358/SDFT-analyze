...
# 输出目录
OUT_SDFT="predictions/alpaca/sdft/inference_sdft"
OUT_SFT="predictions/alpaca/sft/inference_sft"
...
python Mutual-Information/revalue.py alpaca
echo ">>> HSIC computation completed. See results/<dataset>_hsic.log"
