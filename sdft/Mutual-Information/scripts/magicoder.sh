...
#
# Performs inference on the magicoder_train dataset using:
...
DATASET="magicoder_train"
TEMPLATE="alpaca"

# Adapter paths
ADAPTER_SDFT="checkpoints/magicoder/sdft"
ADAPTER_SFT="checkpoints/magicoder/sft"
...
# Output directories
OUT_SDFT="predictions/magicoder/sdft/inference_sdft"
OUT_SFT="predictions/magicoder/sft/inference_sft"
...
python Mutual-Information/revalue.py magicoder
echo ">>> HSIC computation completed. See results/magicoder_hsic.log"