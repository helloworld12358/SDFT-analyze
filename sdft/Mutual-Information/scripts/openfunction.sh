...
#
# Performs inference on the openfunction_train dataset using:
...
DATASET="openfunction_train"
TEMPLATE="alpaca"

# Adapter paths
ADAPTER_SDFT="checkpoints/openfunction/sdft"
ADAPTER_SFT="checkpoints/openfunction/sft"
...
# Output directories
OUT_SDFT="predictions/openfunction/sdft/inference_sdft"
OUT_SFT="predictions/openfunction/sft/inference_sft"
...
python Mutual-Information/revalue.py openfunction
echo ">>> HSIC computation completed. See results/openfunction_hsic.log"