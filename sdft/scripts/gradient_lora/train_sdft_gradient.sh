...
ADAPTER_BASE_DIR="/inspire/hdd/project/continuinglearinginlm/weiyuqi-CZXS25110007/sdft/epoch1_checkpoints"
...
for TRAIN_DATASET in "${DATASETS[@]}"; do
    ...
    ADAPTER_DIR="${ADAPTER_BASE_DIR}/${TRAIN_DATASET}/sdft"
    OUTPUT_FOLDER="analysis/${TRAIN_DATASET}/gradient_analysis_sdft"
