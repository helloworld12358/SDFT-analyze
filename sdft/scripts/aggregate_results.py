...
# 仅修改这里即可
# =======================
C_START_WEIGHT = 10000000   # ← 改成 100 或其他值
# =======================
...
def build_tables(results_dir: str):
    ...
    for fname in sorted(os.listdir(results_dir)):
        ...
        if v_align is None and c_start is None and c_end is None:
            continue
        ...
        total = s_v + C_START_WEIGHT * s_s + s_e
...
def save_single_txt(results_dir: str, prec: int = 6) -> str:
    ...
    formula_str = f"V_align + {C_START_WEIGHT}*C_start + C_end"
    ...
    out_name = f"aggregate_single_txt_w{C_START_WEIGHT}.txt"
