...
METHODS=("sdft" "sft")
COMPARATORS=(
    "gradient_analysis_original_METHOD_alpacaeval"
    "gradient_analysis_original_METHOD_gsm8ktest"
    "gradient_analysis_original_METHOD_openfunctiontest"
)
...
echo "  Comparators per call ($TOTAL_COMPARATORS): gradient_analysis_original_METHOD_alpacaeval gradient_analysis_original_METHOD_gsm8ktest gradient_analysis_original_METHOD_openfunctiontest"
...
for DATASET in "${DATASETS[@]}"; do
    for METHOD in "${METHODS[@]}"; do
        ...
        # 设置基准文件路径
        BASE_FILE="$ROOT_DIR/$DATASET/gradient_analysis_original_$METHOD/merged/avg_grad.pt"
